...
public interface CircularList {
    ...
    /**
     * Provides an iterator of the list, which yields next elements circularly.
     *
     * @return an iterator of the list, which yields next elements circularly
     */
    Iterator<Integer> forwardIterator();

    /**
     * Provides an iterator of the list, which yields previous elements circularly.
     *
     * @return an iterator of the list, which yields next elements circularly.
     */
